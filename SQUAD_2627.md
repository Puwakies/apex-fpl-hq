...
## 🔋 2D) ทีมเตรียม BENCH BOOST GW2 — 4-4-2 · £100.0m

**หลักคิด BB:** ทุก 15 คนได้แต้ม → จัดให้ **ทั้ง 15 ลงเล่น + ฟิกซ์เจอร์ GW2 ดีสุด** (ไม่มีตัวสำรองถูกที่ไม่ลง) · น้ำหนัก = ฟิกซ์เจอร์ **GW2 เดี่ยว** · **avg squad(15) GW2-FDR = 2.22** (12/15 เตะเหย้าเจอทีมอ่อน)

| ตำแหน่ง | ผู้เล่น | ทีม | ราคา | 25/26 pts | ตัวจริง | GW2 |
|---|---|---|---|---|---|---|
| GK | **Roefs** | SUN | 5.0 | 136 | 35 | 2H vs FUL |
| DEF | **Senesi** | TOT | 6.0 | 175 | 37 | 2H vs NEW |
| DEF | **Mukiele** | SUN | 5.5 | 151 | 32 | 2H vs FUL |
| DEF | **Van Hecke** | TOT | 5.0 | 148 | 36 | 2H vs NEW |
| DEF | **Shaw** | MUN | 4.5 | 113 | 38 | 2H vs IPS |
| MID | **B.Fernandes** 🔒 (C) | MUN | 12.0 | 235 | 35 | 2H vs IPS |
| MID | **E.Le Fée** | SUN | 6.0 | 147 | 33 | 2H vs FUL |
| MID | **Fernandes** | TOT | 6.0 | 135 | 35 | 2H vs NEW |
| MID | **Caicedo** | CHE | 5.5 | 110 | 32 | 2H vs BHA |
| FWD | **João Pedro** | CHE | 7.5 | 177 | 31 | 2H vs BHA |
| FWD | **Haaland** 🔒 | MCI | 15.5 | 239 | 34 | 3A vs CRY |
| **ม้านั่ง (นับด้วยตอน BB)** | Sánchez | CHE | 5.0 | 113 | 35 | 2H vs BHA |
| ม้านั่ง | Dalot | MUN | 5.0 | 111 | 29 | 2H vs IPS |
| ม้านั่ง | Ampadu | LEE | 5.5 | 134 | 35 | 3H vs BRE |
| ม้านั่ง | Calvert-Lewin | LEE | 6.0 | 142 | 30 | 3H vs BRE |

- ✅ **ทั้ง 15 คนลงตัวจริง** (≥25 นัดปีก่อน) + ทุกคน AVAILABLE — ม้านั่งก็เก็บแต้มได้จริงตอน BB
- ✅ **เกาะทีมเหย้าง่าย GW2:** SUN×3 / TOT×3 / MUN×3 / CHE×3 (ทั้งหมด 2H เจอทีมอ่อน) + LEE×2 (3H) + Haaland
- **กัปตัน GW2 = B.Fernandes** (MUN 2H vs IPS เลื่อนชั้น + ยิงจุดโทษ) — คุ้มกว่า Haaland ที่เจอ CRY เยือน (3A) สัปดาห์นี้
- ⚠️ **ความเสี่ยง BB:** กระจุก 3 คน/ทีม (SUN/TOT/MUN/CHE) → ถ้าทีมไหนวันซวยจะเสีย 3 ตัวพร้อมกัน — ธรรมดาของการ max ฟิกซ์เจอร์ตอน BB
- 📌 **วิธีใช้:** ทีมนี้ปรับให้ **GW2 สูงสุด** → ตั้งเป็นทีม GW1 เลย (GW1 ทีมพวกนี้ส่วนใหญ่เตะเยือน = อ่อนกว่านิด) แล้วกด **BB ที่ GW2** · ต่างจากทีมสปรินต์ §2B (คนละเป้าหมาย) — เลือกใช้อันเดียวตามแผน chip
- หมายเหตุ: GW1–6 ไม่มี DGW → BB GW2 เป็นการ "BB สัปดาห์เดี่ยว" (ม้านั่งเตะรอบเดียว) เพดานต่ำกว่า BB ตอน DGW แต่ทีมนี้รีดได้สูงสุดเท่าที่ single-GW ทำได้
